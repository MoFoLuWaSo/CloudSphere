...
class RubyTemplate
{
    public function createTemplate()
    {
        ...
        $securityGroupName = "RubyOpsGroup";
      ...
      //  $userData = $this->createUserData();
        ...
        //create instance
        $instanceName = "RubyInstance";
        $template->addResources($instanceName, $this->createInstance($keyPair, $imageId, $securityGroupName));
        ...
        $template->generateTemplate("rubyTemplate");
    }
    ...
    public function createInstance($keyPair, $imageId, $securityGroup)
    {
        $ec2 = new Instance();
        ...
        $ec2->setTags([["Key" => "Name", "Value" => "RubyOpsInstance"]]);
